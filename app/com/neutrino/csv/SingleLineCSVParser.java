 ...
 * @author Rainer Pruy
 */
public class SingleLineCSVParser {
    ...
    public static final int INITIAL_READ_SIZE = 512;
     ...
     */
    public SingleLineCSVParser(char separator) {
     ...
     */
    public SingleLineCSVParser(char separator, char quotechar) {
     ...
     */
    public SingleLineCSVParser(char separator, char quotechar, char escape) {
     ...
     */
    public SingleLineCSVParser(char separator, char quotechar, char escape, boolean strictQuotes) {
     ...
     */
    public String[] parseLine(char[] nextLine) throws IOException {
     ...
     */
    private boolean isNextCharacterEscapedQuote(char[] nextLine, boolean inQuotes, int i) {
     ...
     * @return true if the following character is a quote
     */
    protected boolean isNextCharacterEscapable(char[] nextLine, boolean inQuotes, int i) {
        return inQuotes  // we are in quotes, therefore there can be escaped quotes in here.
                && nextLine.length > (i + 1)  // there is indeed another character to check.
